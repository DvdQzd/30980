...
const empleados = new normalizr.schema.Entity("empleados");
...
const data_denormalizada = desnormalizar(data_normalizada.result, holdingSchema, data_normalizada.entities);

console.log("Antes: ", JSON.stringify(holding).length);
console.log("Despues: ", JSON.stringify(data_normalizada).length);

// console.log(JSON.stringify(data_normalizada));
// console.log(JSON.stringify(data_denormalizada));

function print (myObjecto) {
    // console.log(data_normalizada)
    console.log(util.inspect(myObjecto, true, 12, true));
}
